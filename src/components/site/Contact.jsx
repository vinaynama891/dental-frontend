      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            {[
              {
                icon: MapPin,
                title: "Visit us",
                text: "123 Smile Avenue, Wellness District, NY 10001",
              },
              ...
              <div
                key={c.title}
                className="glass rounded-2xl p-5 shadow-soft flex items-start gap-4"
              >
          ...
          <form onSubmit={submit} className="glass rounded-3xl p-6 sm:p-8 shadow-soft space-y-4">
            ...
            <Button type="submit" className="w-full gradient-bg text-white shadow-glow">
              Send Message
            </Button>
          </form>
        </div>
