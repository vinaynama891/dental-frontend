...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-28 pb-16 overflow-hidden">
      ...
      <div
        className="blob w-[400px] h-[400px] bg-secondary top-40 right-0 animate-float"
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-xl">
            Advanced dental care with expert doctors, painless treatment, and modern technology —
            designed around your comfort.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="#appointment">
              <Button size="lg" className="gradient-bg text-white shadow-glow hover:opacity-90">
